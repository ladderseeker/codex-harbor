...
- [P011 implementation and review](reports/2026-09-08-p011-development.md): actual private preview UI/API, Linux and installed checkpoints, recovered evidence, reviewed lifecycle corrections and cumulative critical acceptance; main and protected/fresh-host restore gates remain explicit. See the current [preview guide](user/previews.md) and [developer setup](developer/previews.md).
