...
This directory describes available behavior, developer workflows, and completed reports. P001/P002/P005 are Implemented with required verification/follow-ups still open; the proposal index distinguishes current evidence from finished delivery.
