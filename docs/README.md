...
This directory describes available behavior, developer workflows, and completed reports. P001 is Implemented with required verification/follow-ups still open; the proposal index distinguishes current evidence from finished delivery.
