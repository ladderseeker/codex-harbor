...
## Query-recency clarification — 20 September 2026

The owner subsequently clarified that only sending a query should move a conversation; merely opening it must preserve its position. P023 reopened for this narrower correction, superseding this report's selected-first/event-update behavior while preserving its evidence as historical. The [query-recency report](2026-09-20-query-recency.md) owns the new implementation, gates, reviews and deployment.
