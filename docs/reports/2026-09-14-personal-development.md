...
The quoted conversation titles above are now English translations, not literal runtime text. This language-only edit preserves all historical results and source identities. No application checks were rerun.
