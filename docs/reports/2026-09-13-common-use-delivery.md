...
| Native history/restart acceptance | The audit found the missing P007 specialist live scenario. Its [implementation/evidence issue](../../issues/2026-09-13-110315-common-use-live-acceptance.md) is separate from credentials. Actual execution remains required. |
