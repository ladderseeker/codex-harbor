...
This feature's [proposal](../../design/proposals/005-attachments-and-rich-input.md) is Implemented after three review rounds, with required real-account and cross-feature integration gates still open. Dedicated real-account image/text response verification is blocked by the [live credential gate](../../issues/2026-09-07-171225-live-runtime-credentials.md).
