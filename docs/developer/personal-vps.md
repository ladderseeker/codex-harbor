...
Managed worktrees/copies, file-editor tools, attachments, terminals, schedules, previews, API tokens and explicit uncertain-work recovery are unavailable in this profile. Conversation tools remain the file-editing path. Account settings explain SSH onboarding and show native readiness.
