...
P015 is Implemented; source `13204d7` is deployed. The [proposal](../../design/proposals/015-personal-vps-workspace.md) owns acceptance and the [decision](../../design/decisions/011-personal-vps-workspace.md) defines its personal trust model. Commands below exist in the current implementation. The [14 September report](../reports/2026-09-14-personal-development.md) records real installed account/development/preview/continuation acceptance and the remaining verification gates; proposal verification is still open.
