...
On 21 September 2026, P018/P024 were deployed as `/opt/harbor-personal/releases/p018-p024-817c3d097166`, source commit `817c3d0971665871b64aa29c0fb25e8c8b132f02`, manifest SHA256 `f009fb788dc60ee2bc56f7be2b1fa42ce0bfb2d8df9d72ec085e17a7cfc3a8bc`. The [delivery record](../reports/2026-09-21-p018-concurrency.md#committed-release-and-vps-delivery) identifies the verified package, drain/checkpoint, migrations 019/020, installed service/HTTPS/account checks and same-host recovery limits. The predecessor was `/opt/harbor-personal/releases/p023-27c1e7d16f2d`; it is retained for deliberate matched-state recovery, never for opening the upgraded database.
