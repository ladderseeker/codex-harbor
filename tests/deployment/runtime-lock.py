...
node = [
    ...
    str(source / "tests/deployment/runtime-lock.ts"),
]
...
try:
    ...
    evidence = {
        ...
        "newGenerationReadOnlyInitializeAndRetire": True,
        "originalUncertaintyAndReservationPreserved": True,
        "modelRequests": 0,
