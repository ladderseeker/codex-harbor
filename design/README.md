...
- [D007 — Separate project-preview origins and a confined runner connection](decisions/007-confined-project-preview-origins.md): accepted origin, browser-grant, fixed relay and reader-lease contract for P011; implementation and browser/Linux evidence remain pending.
