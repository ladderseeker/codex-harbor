...
The prototype is separate from the accepted [architecture](../architecture.md) and existing [proposal delivery states](../proposals/README.md). Integrating the design will require the applicable conversation, workspace and permission contracts and real application verification.
