...
The initial six workflow requirements are extended by [D012](012-personal-vps-development.md) to the owner-selected complete development loop. Disable unsupported managed capabilities in both UI/API. P009 recovery, deferred extensions/self-development and unrelated release gates retain their existing owners and status. This profile has its own installation and acceptance evidence, never a claim that P009 is Verified.
