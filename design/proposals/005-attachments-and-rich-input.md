...
- [Selection regression](../../issues/2026-09-08-044009-p005-selection-regression.md): Medium, In progress. Two cumulative runs failed selection visibility before reload, including one after the Attach control was enabled. A diagnostic-only critical rerun passed; cause remains unestablished and is not attributed to the previously resolved 429 finding.
