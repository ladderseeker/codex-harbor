...
- [Upload-recovery visibility timeout](../../issues/2026-09-07-224419-p005-reload-visibility.md): Low, Open. An unexplained initial Node 24 test failure remains a diagnostic follow-up; the later matching-source full acceptance passed without a production change. Its record and the integration report preserve that limitation.
