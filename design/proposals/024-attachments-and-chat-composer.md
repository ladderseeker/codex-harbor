...
The current regression deadlocks are tracked separately in the [parent-lock issue](../../issues/2026-09-21-163057-conversation-parent-lock-deadlocks.md), owned by Main under P024-R4. Add `issues/2026-09-21-163057-conversation-parent-lock-deadlocks.md` and its matching archive path to the exact documentation fence. No product-file expansion is admitted until the concrete correction is settled.
