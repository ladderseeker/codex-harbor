...
P001–P003/P005/P007 are Accepted and Implemented, with required live-account evidence and upstream follow-ups still open. P004/P006/P009 are Accepted and In progress. P008/P010/P011/P012 are Accepted and Planned after design review. No proposal has passed its completion gate. Design review, implementation, and verification are separate events. Follow the [proposal template](../proposal-template.md) and [canonical lifecycle rules](../../AGENTS.md#document-ownership-and-lifecycle) when changing status.
...
| [P004](004-files-and-change-review.md) | Inspect, edit, download, and review project changes through Harbor | Accepted | In progress | P003 | Editor/file/Git/uncertainty implementation started; P004-01–06 acceptance and isolation pending |
...
| [P006](006-persistent-terminal.md) | Use and reconnect to a terminal in a selected project workspace | Accepted | In progress | P003 | Bounded PTY/control/replay implementation started; P006-01–06 acceptance and actual Linux pending |
...
| [P008](008-scheduled-tasks.md) | Run recurring or one-time work and review its results | Accepted | Planned | P003, P007 | One independent design review closed; P008-01–07 implementation and live pending |
| [P009](009-portable-deployment-and-restore.md) | Install, update, back up, and restore a working Harbor on a compatible VPS | Accepted | In progress | P001, P007 | D006 implementation and Linux checks in progress; off-host backup authorization and live gates blocked |
| [P010](010-self-development.md) | Develop and test Harbor through its running stable instance | Accepted | Planned | P002, P003, P009 | D008 worker/broker design review closed; self E2E/isolation implementation, checkpoint and live gates pending |
| [P011](011-private-project-previews.md) | Open a private preview of a project's running application | Accepted | Planned | P003 | D007 and complete contract reviewed; P011-01–06 browser/relay/isolation implementation pending |
| [P012](012-managed-skills-and-mcp.md) | Configure and use trusted skills and MCP tools within a project | Accepted | Planned | P003 | Local skill/MCP design review closed; account-free protocol spike passed, implementation/live/Linux pending |

Next action: implement P004 files, P006 terminals and P009 deployment on the tested conversation/token/workspace/attachment/recovery baseline; P008 scheduling, P010 self-development, P011 private previews and P012 local extensions have reviewed contracts ready for their implementation slots. Keep the live-account, gateway and storage-inventory gates visible. [Dedicated live credentials are unavailable](../../issues/2026-09-07-171225-live-runtime-credentials.md), and [automatic approval review blocked the P009 backup transfer](../../issues/2026-09-07-231526-p009-backup-transfer-approval.md); continue unaffected work without claiming either mandatory gate passed. The transferred [runtime compatibility finding](../../issues/archive/2026-09-07-073831-codex-runtime-compatibility.md) has partial evidence owned by [P001's local gate](001-secure-persistent-conversations.md#source-issues) and pending [P009 deployment evidence](009-portable-deployment-and-restore.md#source-issues).
