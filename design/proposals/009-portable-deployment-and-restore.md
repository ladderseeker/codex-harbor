...
- [P009 implementation review](../../issues/2026-09-08-005028-p009-implementation-review.md): High, In progress. Round1 found broken administrator wrapper/status paths and checkpoint/restore consistency, unknown-byte preservation and removed-workspace history gaps. P009-01–07 own correction and independent round2; local checks do not replace the separately blocked protected transfer/live gates.
