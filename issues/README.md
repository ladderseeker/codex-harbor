...
The critical P001 implementation review is resolved in the archive. P007's first implementation review, a newly reproduced authority-expiry defect, the live-account blocker, and two medium follow-ups remain active. The earlier runtime finding remains Transferred with partial local evidence below.
