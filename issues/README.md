...
| --- | --- | --- | --- | --- |
| [P004 implementation review](2026-09-08-012652-p004-implementation-review.md) | High | In progress | P004 | Fix pending-open draft loss, BOM/mode preservation and receipt-parent durability; verify the correction batch before P006/P009 integration. |
