...
The archive contains resolved source-review findings, installed web/workspace corrections, authority and retention corrections, allocation detection/reconciliation, the P002/P005 harness corrections, the Linux native PTY test prerequisite, and reviewed preview lifecycle corrections. Shared acknowledgement integration, test-host access recovery, P010 integration, P004/P006 restore obligations, P005/P007 regression observations, live-account and backup-transfer blockers, and gateway availability remain active. The earlier runtime finding remains Transferred with partial local evidence below.
