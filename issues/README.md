...
| [P012 implementation review](2026-09-13-042641-p012-implementation-review.md) | Medium | In progress | P012 | Four corrections passed two matching application runs and independent round 2; finish actual R1 physical removal, visible UI acceptance, main integration and current regressions. |
