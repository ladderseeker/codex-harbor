...
| --- | --- | --- | --- | --- |
| [P010 worker backing reserve](2026-09-13-044423-p010-worker-backing-reserve.md) | High | In progress | P010 | Combined backing budget and related cleanup source reviews passed with qualified Linux denial evidence; finish supported positive admission, cleanup/resource acceptance and main integration. |
...
| [P010 source upload boundary](2026-09-13-052647-p010-source-upload-boundary.md) | Low | In progress | P010 | Align the accepted source payload with its framed wire limit, verify the exact boundary and independently review before main integration. |
