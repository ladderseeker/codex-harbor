...
- Owner: Main, reopened [P024](../../design/proposals/archive/024-attachments-and-chat-composer.md#reopened-installed-delivery-correction--21-september-2026), P024-R1–R5.
...
P024-R1–R5 passed and the reviewed correction is installed as `311f750a18bb8bc400ddfc497b82b0f5de6e9e25`. Publication now respects the existing root-owned parent and hardened service umask; the composer reserves submission through draft saving and clears acknowledged attachments. Guarded projection repair restores input after confirmed personal runtime retirement. Real Linux application/native checks, four actual-model turns, personal concurrency regressions and three paired review rounds establish the selected behavior. Installed identity, account, policy, all-zero drain, backup and usable composer checks passed; see the [final evidence](../../docs/reports/2026-09-21-p024-installed-attachment-fix.md#final-deployment-and-installed-acceptance).

The affected conversation's draft/history/attachment fingerprints are unchanged across reboot and deployment. Its later 34 KiB image was already marked deleted before the first pre-reboot observation; no owner image was resent. The specific earlier owner browser race remains unproven, although the old-UI negative control reproduces the corrected race. Separate normal-stop retention and managed interruption issues remain open.
